...
func (c *SuggestionboxClient) CheckFaceprint(ctx context.Context, request *CheckFaceprintRequest) (*CheckFaceprintResponse, error) {
	resp, err := c.CheckFaceprintMulti(ctx, []*CheckFaceprintRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.CheckFaceprint: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) CheckFaceprintMulti(ctx context.Context, requests []*CheckFaceprintRequest) ([]*CheckFaceprintResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckFaceprint: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.CheckFaceprint: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.CheckFaceprint: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckFaceprint: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.CheckFaceprint", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckFaceprint: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckFaceprint: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.CheckFaceprint: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckFaceprint: read response body")
	}
	var resps []*CheckFaceprintResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckFaceprint: decode response body")
	}
	return resps, nil
}

func (c *SuggestionboxClient) CheckFile(ctx context.Context, request *CheckFileRequest) (*CheckFileResponse, error) {
	resp, err := c.CheckFileMulti(ctx, []*CheckFileRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.CheckFile: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) CheckFileMulti(ctx context.Context, requests []*CheckFileRequest) ([]*CheckFileResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckFile: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.CheckFile: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.CheckFile: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckFile: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.CheckFile", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckFile: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckFile: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.CheckFile: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckFile: read response body")
	}
	var resps []*CheckFileResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckFile: decode response body")
	}
	return resps, nil
}

func (c *SuggestionboxClient) CheckURL(ctx context.Context, request *CheckURLRequest) (*CheckURLResponse, error) {
	resp, err := c.CheckURLMulti(ctx, []*CheckURLRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.CheckURL: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) CheckURLMulti(ctx context.Context, requests []*CheckURLRequest) ([]*CheckURLResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckURL: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.CheckURL: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.CheckURL: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckURL: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.CheckURL", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckURL: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckURL: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.CheckURL: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckURL: read response body")
	}
	var resps []*CheckURLResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.CheckURL: decode response body")
	}
	return resps, nil
}

func (c *SuggestionboxClient) FaceprintCompare(ctx context.Context, request *FaceprintCompareRequest) (*FaceprintCompareResponse, error) {
	resp, err := c.FaceprintCompareMulti(ctx, []*FaceprintCompareRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.FaceprintCompare: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) FaceprintCompareMulti(ctx context.Context, requests []*FaceprintCompareRequest) ([]*FaceprintCompareResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.FaceprintCompare: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.FaceprintCompare: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.FaceprintCompare: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.FaceprintCompare: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.FaceprintCompare", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.FaceprintCompare: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.FaceprintCompare: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.FaceprintCompare: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.FaceprintCompare: read response body")
	}
	var resps []*FaceprintCompareResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.FaceprintCompare: decode response body")
	}
	return resps, nil
}
...
func (c *SuggestionboxClient) RemoveID(ctx context.Context, request *RemoveIDRequest) (*RemoveIDResponse, error) {
	resp, err := c.RemoveIDMulti(ctx, []*RemoveIDRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.RemoveID: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) RemoveIDMulti(ctx context.Context, requests []*RemoveIDRequest) ([]*RemoveIDResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.RemoveID: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.RemoveID: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.RemoveID: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.RemoveID: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.RemoveID", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.RemoveID: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.RemoveID: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.RemoveID: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.RemoveID: read response body")
	}
	var resps []*RemoveIDResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.RemoveID: decode response body")
	}
	return resps, nil
}

func (c *SuggestionboxClient) Rename(ctx context.Context, request *RenameRequest) (*RenameResponse, error) {
	resp, err := c.RenameMulti(ctx, []*RenameRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.Rename: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) RenameMulti(ctx context.Context, requests []*RenameRequest) ([]*RenameResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.Rename: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.Rename: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.Rename: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.Rename: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.Rename", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.Rename: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.Rename: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.Rename: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.Rename: read response body")
	}
	var resps []*RenameResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.Rename: decode response body")
	}
	return resps, nil
}

func (c *SuggestionboxClient) RenameID(ctx context.Context, request *RenameIDRequest) (*RenameIDResponse, error) {
	resp, err := c.RenameIDMulti(ctx, []*RenameIDRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.RenameID: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) RenameIDMulti(ctx context.Context, requests []*RenameIDRequest) ([]*RenameIDResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.RenameID: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.RenameID: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.RenameID: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.RenameID: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.RenameID", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.RenameID: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.RenameID: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.RenameID: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.RenameID: read response body")
	}
	var resps []*RenameIDResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.RenameID: decode response body")
	}
	return resps, nil
}

func (c *SuggestionboxClient) SimilarFile(ctx context.Context, request *SimilarFileRequest) (*SimilarFileResponse, error) {
	resp, err := c.SimilarFileMulti(ctx, []*SimilarFileRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.SimilarFile: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) SimilarFileMulti(ctx context.Context, requests []*SimilarFileRequest) ([]*SimilarFileResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarFile: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.SimilarFile: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.SimilarFile: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarFile: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.SimilarFile", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarFile: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarFile: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.SimilarFile: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarFile: read response body")
	}
	var resps []*SimilarFileResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarFile: decode response body")
	}
	return resps, nil
}

func (c *SuggestionboxClient) SimilarID(ctx context.Context, request *SimilarIDRequest) (*SimilarIDResponse, error) {
	resp, err := c.SimilarIDMulti(ctx, []*SimilarIDRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.SimilarID: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) SimilarIDMulti(ctx context.Context, requests []*SimilarIDRequest) ([]*SimilarIDResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarID: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.SimilarID: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.SimilarID: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarID: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.SimilarID", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarID: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarID: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.SimilarID: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarID: read response body")
	}
	var resps []*SimilarIDResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarID: decode response body")
	}
	return resps, nil
}

func (c *SuggestionboxClient) SimilarURL(ctx context.Context, request *SimilarURLRequest) (*SimilarURLResponse, error) {
	resp, err := c.SimilarURLMulti(ctx, []*SimilarURLRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.SimilarURL: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) SimilarURLMulti(ctx context.Context, requests []*SimilarURLRequest) ([]*SimilarURLResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarURL: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.SimilarURL: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.SimilarURL: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarURL: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.SimilarURL", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarURL: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarURL: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.SimilarURL: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarURL: read response body")
	}
	var resps []*SimilarURLResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.SimilarURL: decode response body")
	}
	return resps, nil
}

func (c *SuggestionboxClient) TeachFaceprint(ctx context.Context, request *TeachFaceprintRequest) (*TeachFaceprintResponse, error) {
	resp, err := c.TeachFaceprintMulti(ctx, []*TeachFaceprintRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.TeachFaceprint: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) TeachFaceprintMulti(ctx context.Context, requests []*TeachFaceprintRequest) ([]*TeachFaceprintResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachFaceprint: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.TeachFaceprint: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.TeachFaceprint: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachFaceprint: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.TeachFaceprint", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachFaceprint: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachFaceprint: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.TeachFaceprint: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachFaceprint: read response body")
	}
	var resps []*TeachFaceprintResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachFaceprint: decode response body")
	}
	return resps, nil
}

func (c *SuggestionboxClient) TeachFile(ctx context.Context, request *TeachFileRequest) (*TeachFileResponse, error) {
	resp, err := c.TeachFileMulti(ctx, []*TeachFileRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.TeachFile: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) TeachFileMulti(ctx context.Context, requests []*TeachFileRequest) ([]*TeachFileResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachFile: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.TeachFile: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.TeachFile: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachFile: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.TeachFile", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachFile: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachFile: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.TeachFile: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachFile: read response body")
	}
	var resps []*TeachFileResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachFile: decode response body")
	}
	return resps, nil
}

func (c *SuggestionboxClient) TeachURL(ctx context.Context, request *TeachURLRequest) (*TeachURLResponse, error) {
	resp, err := c.TeachURLMulti(ctx, []*TeachURLRequest{request})
	if err != nil {
		return nil, err
	}
	if len(resp) == 0 {
		return nil, errors.New("SuggestionboxClient.TeachURL: no response")
	}
	return resp[0], nil
}

func (c *SuggestionboxClient) TeachURLMulti(ctx context.Context, requests []*TeachURLRequest) ([]*TeachURLResponse, error) {
	b, err := json.Marshal(requests)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachURL: encode request")
	}
	buf := c.bufs.Get()
	defer c.bufs.Put(buf)
	w := multipart.NewWriter(buf)
	...
	if files, ok := ctx.Value(contextKeyFiles).(map[string]file); ok {
		for fieldname, file := range files {
			f, err := w.CreateFormFile(fieldname, file.filename)
			if err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.TeachURL: create form file")
			}
			if _, err := io.Copy(f, file.r); err != nil {
				return nil, errors.Wrap(err, "SuggestionboxClient.TeachURL: reading file")
			}
			select {
			case <-ctx.Done():
				return nil, ctx.Err()
	...
	if err := w.Close(); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachURL: write")
	}
	req, err := http.NewRequest(http.MethodPost, c.endpoint+"/remoto/Suggestionbox.TeachURL", buf)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachURL: new request")
	}
	req.Header.Set("Accept", "application/json; charset=utf-8")
	req.Header.Set("Content-Type", w.FormDataContentType())
	req = req.WithContext(ctx)
	resp, err := c.httpclient.Do(req)
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachURL: do")
	}
	if resp.StatusCode != http.StatusOK {
		resp.Body.Close()
		return nil, errors.Errorf("SuggestionboxClient.TeachURL: remote service returned %s", resp.Status)
	}
	b, err = ioutil.ReadAll(resp.Body)
	resp.Body.Close()
	if err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachURL: read response body")
	}
	var resps []*TeachURLResponse
	if err := json.Unmarshal(b, &resps); err != nil {
		return nil, errors.Wrap(err, "SuggestionboxClient.TeachURL: decode response body")
	}
	return resps, nil
}
